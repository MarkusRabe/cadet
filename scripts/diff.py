...
if __name__ == "__main__":
    ...
    return_value2, output2, error2 = call("./cadet -v 1 --pg " + sys.argv[1], 10)
    
    if return_value1 == 42 and return_value2 == 42:
        matches1 = re.findall("Deterministic vars: (\d+)", output1, flags=0)
        matches2 = re.findall("Deterministic vars: (\d+)", output2, flags=0)
